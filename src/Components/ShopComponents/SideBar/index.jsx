...
const SideBar =()=>{
    ...
    const handlePrice=event=>{
        ...
        <li><NavLink to="/">Trang phục nữ(211)</NavLink></li>
            <li><NavLink to="/">Đồ ngủ, đồ mặc nhà, đồ lót, đồ bơi(104)</NavLink></li>
            <li><NavLink to="/">Phụ kiện nữ(107)</NavLink></li>
            <li><NavLink to="/">Giày dép nữ(113)</NavLink></li>
          </ul>
        </div>
        <div className="sidebar-box-2">
